...
ExportResult ObjExportWriter::write(const ExportContext& context, const Fio::VecSyEntityPtr& /*entities*/)
{
    ...
    SY_WARNF("[ObjExportWriter] %s (path=%s)", msg.toUtf8().constData(), context.targetPath.toUtf8().constData());
