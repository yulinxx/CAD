...
ExportResult PdfExportWriter::write(const ExportContext& context, const Fio::VecSyEntityPtr& entities)
{
    ...
    return ExportResult::ok(QStringLiteral("PDF export successful"), static_cast<int>(entities.size()));
}