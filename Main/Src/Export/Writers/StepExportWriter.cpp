...
ExportResult StepExportWriter::write(const ExportContext& context, const Fio::VecSyEntityPtr& entities)
{
    ...
    return ExportResult::ok(QStringLiteral("STEP export successful"), static_cast<int>(entities.size()));
}