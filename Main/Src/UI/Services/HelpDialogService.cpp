...
{
    QMessageBox::information(parent, QObject::tr("Settings"),
...
{
    QMessageBox::information(parent, QObject::tr("Documentation"),
...
double HelpDialogService::getDouble(QWidget *parent, const QString &title, const QString &label, double value,
