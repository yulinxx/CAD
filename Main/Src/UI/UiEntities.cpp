...
QString LineEntity2D::id() const { return m_id; }
QString LineEntity2D::name() const { return QStringLiteral("Line"); }
QString LineEntity2D::typeName() const { return QStringLiteral("LineEntity2D"); }
bool LineEntity2D::selected() const { return m_selected; }
void LineEntity2D::setSelected(bool selected) { m_selected = selected; }
bool LineEntity2D::highlighted() const { return m_highlighted; }
void LineEntity2D::setHighlighted(bool highlighted) { m_highlighted = highlighted; }
QPointF LineEntity2D::start() const { return m_start; }
QPointF LineEntity2D::end() const { return m_end; }
void LineEntity2D::setStart(const QPointF& start) { m_start = start; }
void LineEntity2D::setEnd(const QPointF& end) { m_end = end; }
QRectF LineEntity2D::bounds() const { return QRectF(m_start, m_end).normalized(); }
double LineEntity2D::length() const { return QLineF(m_start, m_end).length(); }
...
double LineEntity2D::distanceToPoint(const QPointF& point) const { return pointLineDistance(point, m_start, m_end); }
...
QString PolylineEntity2D::id() const { return m_id; }
QString PolylineEntity2D::name() const { return QStringLiteral("Polyline"); }
QString PolylineEntity2D::typeName() const { return QStringLiteral("PolylineEntity2D"); }
bool PolylineEntity2D::selected() const { return m_selected; }
void PolylineEntity2D::setSelected(bool selected) { m_selected = selected; }
bool PolylineEntity2D::highlighted() const { return m_highlighted; }
void PolylineEntity2D::setHighlighted(bool highlighted) { m_highlighted = highlighted; }
QVector<QPointF> PolylineEntity2D::points() const { return m_points; }
void PolylineEntity2D::setPoints(const QVector<QPointF>& points) { m_points = points; }
...
QString CircleEntity2D::id() const { return m_id; }
QString CircleEntity2D::name() const { return QStringLiteral("Circle"); }
QString CircleEntity2D::typeName() const { return QStringLiteral("CircleEntity2D"); }
bool CircleEntity2D::selected() const { return m_selected; }
void CircleEntity2D::setSelected(bool selected) { m_selected = selected; }
bool CircleEntity2D::highlighted() const { return m_highlighted; }
void CircleEntity2D::setHighlighted(bool highlighted) { m_highlighted = highlighted; }
QPointF CircleEntity2D::center() const { return m_center; }
double CircleEntity2D::radius() const { return m_radius; }
void CircleEntity2D::setCenter(const QPointF& center) { m_center = center; }
...
QString ArcEntity2D::id() const { return m_id; }
QString ArcEntity2D::name() const { return QStringLiteral("Arc"); }
QString ArcEntity2D::typeName() const { return QStringLiteral("ArcEntity2D"); }
bool ArcEntity2D::selected() const { return m_selected; }
void ArcEntity2D::setSelected(bool selected) { m_selected = selected; }
bool ArcEntity2D::highlighted() const { return m_highlighted; }
void ArcEntity2D::setHighlighted(bool highlighted) { m_highlighted = highlighted; }
QPointF ArcEntity2D::center() const { return m_center; }
...
QString SceneNode::id() const { return m_id; }
QString SceneNode::name() const { return m_name; }
QString SceneNode::typeName() const { return QStringLiteral("SceneNode"); }
bool SceneNode::selected() const { return m_selected; }
void SceneNode::setSelected(bool selected) { m_selected = selected; }
bool SceneNode::highlighted() const { return m_highlighted; }
void SceneNode::setHighlighted(bool highlighted) { m_highlighted = highlighted; }
void SceneNode::addChild(const std::shared_ptr<SceneNode>& child) { if (child) m_children.push_back(child); }
QVector<std::shared_ptr<SceneNode>> SceneNode::children() const { return m_children; }
...
QVector<std::shared_ptr<UiEntity>> SelectionSet::items() const { return m_items; }
bool SelectionSet::empty() const { return m_items.isEmpty(); }
...
QVector<std::shared_ptr<LineEntity2D>> EntityDocument2D::lines() const { return m_lines; }
QVector<std::shared_ptr<PolylineEntity2D>> EntityDocument2D::polylines() const { return m_polylines; }
QVector<std::shared_ptr<CircleEntity2D>> EntityDocument2D::circles() const { return m_circles; }
QVector<std::shared_ptr<ArcEntity2D>> EntityDocument2D::arcs() const { return m_arcs; }
SelectionSet& EntityDocument2D::selection() { return m_selection; }
const SelectionSet& EntityDocument2D::selection() const { return m_selection; }
...
QVector<std::shared_ptr<SceneNode>> SceneDocument3D::rootNodes() const { return m_roots; }
